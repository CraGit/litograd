              ...
              <div className="title">
                ...
                {slice?.primary?.heading && (
                  <PrismicRichText 
                    ...
                    components={{
                      heading1: ({ children }) => <h2 className="title_split_anim mb-25">{children}</h2>,
                      heading2: ({ children }) => <h2 className="title_split_anim mb-25">{children}</h2>,
                    }}
                  />
                )}
                {slice?.primary?.description && (
                  <PrismicRichText 
                    ...
                    components={{
                      paragraph: ({ children }) => <p className="wow fadeInUp" data-wow-delay=".4s">{children}</p>,
                    }}
                  />
                )}
              </div>
              <div className="contact__area-left-contact wow fadeInUp" data-wow-delay=".7s">
                <div className="contact__area-left-contact-item">
                  ...
                  <div className="contact__area-left-contact-item-content">
                    ...
                    <h6>
                      <Link href={`tel:${settings?.data?.phone || '+123 (256) 568 58'}`}>
                ...
                <div className="contact__area-left-contact-item">
                  ...
                  <div className="contact__area-left-contact-item-content">
                    <span>{slice?.primary?.email_label || 'Email Address:'}</span>
                    <h6>
                      <Link href={`mailto:${settings?.data?.email || 'needhelp@gmail.com'}`}>
                ...
                <div className="contact__area-left-contact-item">
                  ...
                  <div className="contact__area-left-contact-item-content">
                    ...
                    <h6>
                      <Link 
                        href={settings?.data?.google_map_embed || "https://google.com/maps"} 
                        target="_blank"
                      >
                  ...
                  <div className="col-md-6 mb-25">
                    <div className="contact__form-area-item">
                      <input 
                        type="text" 
                        name="name" 
                        placeholder={slice?.primary?.name_placeholder || "Full Name"} 
                        value={formData.name}
                  ...
                  <div className="col-md-6 md-mb-25">
                    <div className="contact__form-area-item">
                      <input 
                        type="email" 
                        name="email" 
                        placeholder={slice?.primary?.email_placeholder || "Email Address"} 
                  ...
                  <div className="col-md-12 mb-25">
                    <div className="contact__form-area-item">
                      <input 
                        type="text" 
                        name="subject" 
                        placeholder={slice?.primary?.subject_placeholder || "Subject"} 
